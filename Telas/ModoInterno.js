...
import ControleCoolerButton from '../Components/ControleCoolerButton'
import Donut from '../Components/Donut';
import BarChart from '../Components/BarChart';
import TempoFaltante from '../Components/TempoFaltante';


const ModoInterno = ({ navigation }) => {
    return (
        <View>
            ...
            <View style={ControlesStyles.Controle}>
                ...
                <View style={ControlesStyles.ControleCooler}>
                    <Text style={ControlesStyles.TextButton}>Cooler</Text>
                    <ControleCoolerButton />
                </View>
